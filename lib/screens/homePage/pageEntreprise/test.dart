...
class TestBonPriseCharge extends StatefulWidget {
  const TestBonPriseCharge({super.key});

  @override
  State<TestBonPriseCharge> createState() => _TestBonPriseChargeState();
}

class _TestBonPriseChargeState extends State<TestBonPriseCharge> {
  bool value = false;
  String? hostoChoose;
